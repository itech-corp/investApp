        ...
        return (
          <View style={{
            ...
            <View style={{padding:20}}>
                    {item.text.map((element => element==null? <Text style={{padding:1,color:item.bg=='white'?'black':'white',fontSize:15,fontFamily:'Poppins-Regular'}}> </Text> :<Text style={{padding:1,color:item.bg=='white'?'black':'white',fontSize:15,fontFamily:'Poppins-Regular'}}><Icon name="check-circle" size={25} color="#10ae06"  />    {element} </Text>))}
            </View>
            <View style={{
                alignContent:'center',
                padding: 10,
               flex:1,
                ...
                borderTopWidth:.4,
                borderTopColor:'grey'
                }}><Text style={{fontSize:20,fontFamily:'Poppins-Bold',flex:1 ,color:item.bg=='white'?'black':'white'}}>Choose Plan   <Icon name="chevron-right" color="orange" size={30}/><Icon name="chevron-right" color="orange" size={30}/></Text>
